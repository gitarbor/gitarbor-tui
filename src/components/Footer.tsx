...
export function Footer({
  ...
  const getContextualCommands = (): { line1: string; line2: string } => {
    ...
    const globalCommands = '[/] Settings | [?] Help | [P] Push | [p] Pull | [f] Fetch';
    ...
    if (view === 'repos' && focusedPanel === 'filter') {
      ...
      const line2 =
        '[n] New Branch | [D] Delete | [R] Rename | [u] Set Upstream | [U] Unset Upstream | [TAB/Shift+TAB] Panels | [ESC/q] Exit';
      return { line1, line2 };
    } else if (view === 'main' && focusedPanel === 'log') {
      const line1 = `${globalCommands} | [ENTER] View Diff`;
      const line2 =
        '[y] Cherry-pick | [R] Revert | [X] Reset | [Y] Copy Hash | [t] Tag | [TAB/Shift+TAB] Panels | [ESC/q] Exit';
      return { line1, line2 };
    } else if (view === 'main' && focusedPanel === 'stashes') {
      const line1 = `${globalCommands} | [s] Create Stash`;
      const line2 =
        '[ENTER] Apply | [P] Pop | [D] Drop | [V] View Diff | [4] Full Stash View | [TAB/Shift+TAB] Panels | [ESC/q] Exit';
      return { line1, line2 };
    } else if (view === 'main' && focusedPanel === 'remotes') {
      const line1 = `${globalCommands} | [ENTER] Fetch`;
      const line2 =
        '[n] Add Remote | [e] Edit | [D] Delete | [TAB/Shift+TAB] Panels | [ESC/q] Exit';
      return { line1, line2 };
    } else if (view === 'main' && focusedPanel === 'tags') {
      const line1 = `${globalCommands} | [ENTER] Checkout | [i] View Details`;
      const line2 =
        '[n] Create Tag | [t] Tag at HEAD | [D] Delete | [P] Push | [←/→] Switch Tabs | [TAB/Shift+TAB] Panels | [ESC/q] Exit';
      return { line1, line2 };
    } else if (view === 'log') {
      const line1 = `${globalCommands} | [ENTER] View Diff`;
      const line2 =
        '[y] Cherry-pick | [R] Revert | [X] Reset | [Y] Copy Hash | [t] Tag | [1-5] Switch View | [ESC/q] Exit';
      return { line1, line2 };
    } else if (view === 'stash') {
      const line1 = `${globalCommands} | [s] Create Stash`;
      const line2 =
        '[ENTER] Apply | [P] Pop | [D] Drop | [V] View Diff | [1-5] Switch View | [ESC/q] Exit';
      return { line1, line2 };
