      ...
      <box width="100%" flexGrow={1} flexDirection="column">
        <box width="100%" height={2} flexDirection="column" paddingBottom={theme.spacing.xs}>
          ...
          <box width="100%" paddingLeft={theme.spacing.md}>
            <text 
              fg={focusedField === 'name' && editMode ? theme.colors.status.success : theme.colors.text.primary}
            >
        ...
        <box width="100%" height={2} flexDirection="column" paddingBottom={theme.spacing.xs}>
          <box width="100%">
            <text fg={focusedField === 'fetchUrl' ? theme.colors.primary : theme.colors.text.secondary}>
              {focusedField === 'fetchUrl' ? '▶ ' : '  '}Fetch URL:
            </text>
          </box>
          <box width="100%" paddingLeft={theme.spacing.md}>
            <text 
              fg={focusedField === 'fetchUrl' && editMode ? theme.colors.status.success : theme.colors.text.primary}
            >
        ...
        <box width="100%" height={2} flexDirection="column" paddingBottom={theme.spacing.xs}>
          <box width="100%">
            <text fg={focusedField === 'pushUrl' ? theme.colors.primary : theme.colors.text.secondary}>
              {focusedField === 'pushUrl' ? '▶ ' : '  '}Push URL (optional):
            </text>
          </box>
          <box width="100%" paddingLeft={theme.spacing.md}>
            <text 
              fg={focusedField === 'pushUrl' && editMode ? theme.colors.status.success : theme.colors.text.primary}
            >
