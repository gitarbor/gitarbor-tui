      ...
      <box width="100%" flexGrow={1} flexDirection="row">
          ...
          >
            <box flexDirection="column" width="100%" height="100%">
              ...
              <box flexDirection="row" height={1} paddingLeft={theme.spacing.xs}>
                <text
                  fg={
                    branchRemoteTab === 'branches' ? theme.colors.primary : theme.colors.text.muted
                  }
                >
                ...
                <text
                  fg={
                    branchRemoteTab === 'remotes' ? theme.colors.primary : theme.colors.text.muted
                  }
                >
                ...
                <text> </text>
                <text
                  fg={branchRemoteTab === 'tags' ? theme.colors.primary : theme.colors.text.muted}
                >
                        ...
                        return (
                          ...
                          >
                            <box flexDirection="row">
                              ...
                              <text
                                fg={isSelected ? theme.colors.primary : theme.colors.text.secondary}
                              >
                                {' '}
                                {remote.name}
                              </text>
                            ...
                            <box flexDirection="row" paddingLeft={theme.spacing.md}>
                              <text fg={theme.colors.text.muted}>
                                {remote.fetchUrl.length > 40
                                  ? remote.fetchUrl.substring(0, 37) + '...'
                                  : remote.fetchUrl}
                              </text>
                            </box>
                          </box>
                      ...
                      {tags.map((tag, idx) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <text
                              fg={isSelected ? theme.colors.primary : theme.colors.git.modified}
                            >
                              {' '}
                              {tag.isAnnotated ? '◆ ' : '◇ '}
                              {tag.name}
        ...
        <box width="60%" flexDirection="column">
          ...
          >
            {isLoadingDiff ? (
              <box paddingLeft={theme.spacing.xs}>
                <text fg={theme.colors.text.muted}>Loading diff...</text>
              </box>
            ) : !diff || diff.trim() === '' ? (
              <box paddingLeft={theme.spacing.xs}>
          ...
          {showCommandLog && <ActivityLog activityLog={commandLog} maxHeight={10} />}
        </box>
      </box>
    </box>
  );
