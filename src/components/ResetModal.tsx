    ...
    >
      ...
      >
        <box flexDirection="row">
          <text fg={theme.colors.primary}>Reset to Commit</text>
        </box>
        ...
        <box flexDirection="row" marginTop={theme.spacing.xs}>
          ...
          <text fg={selectedMode === 'soft' ? theme.colors.text.primary : theme.colors.text.secondary}>
        ...
        <box flexDirection="row">
          ...
          <text fg={selectedMode === 'mixed' ? theme.colors.text.primary : theme.colors.text.secondary}>
        ...
        <box flexDirection="row">
          ...
          <text fg={selectedMode === 'hard' ? theme.colors.status.error : theme.colors.text.secondary}>
